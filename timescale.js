...
var timescale = (function() {
  ...
  var saveImage = function() {
    ...
    var svg = document.querySelector('.timescale svg'); // Select the SVG element
    var serializer = new XMLSerializer();
    var svgStr = serializer.serializeToString(svg);

    // Create a Canvas
    var canvas = document.createElement('canvas');
    canvas.width = svg.getBoundingClientRect().width; // Set canvas size
    ...
    var url = DOMdocument.addEventListener('DOMContentLoaded', function() {
      // Check if the button exists in your HTML
      console.log('Save button clicked');
      var saveImageButton = document.getElementById('saveImageBtn');
      if (saveImageButton) {
